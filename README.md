...
Companion repository for the Cloudy Musings post (**Deploying a VM into an Existing Virtual Network: ARM, Bicep, and Terraform**)[https://www.shankuehn.io/post/deploying-a-vm-into-an-existing-virtual-network-arm-bicep-and-terraform].
